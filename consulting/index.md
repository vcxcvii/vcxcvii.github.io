...
service_type: AI-native B2B SaaS marketing consulting
mcp: true
redirect_from:
...
- At GTM Buddy, I led a team of 3 and 4 agencies that sourced 4x the annual marketing budget in pipeline. I also built the pipeline view used by leadership and investors, and led positioning, messaging, sales enablement, and the launch of Nucleus, which reached 20 alpha customers.
...
- In consulting work, I built a sales content system at Vendasta used by 200+ reps with 100% adoption, rebuilt the sales asset set at GTM Buddy against their own rep engagement data, and ran positioning and outbound at Pazo and LucioAI, tied to 2 enterprise logo wins. [What the first 30 days looks like](/consulting/first-30-days/).
